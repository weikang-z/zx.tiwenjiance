define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'editable'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'symptoms_data/index' + location.search,
                    add_url: 'symptoms_data/add',
                    edit_url: 'symptoms_data/edit',
                    del_url: 'symptoms_data/del',
                    multi_url: 'symptoms_data/multi',
                    import_url: 'symptoms_data/import',
                    table: 'symptoms_data',
                }
            });
