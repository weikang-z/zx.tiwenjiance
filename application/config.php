...
return [
	...
	// 错误显示信息,非调试模式有效
	'error_message' => '<h1 style="text-align:center;margin-top:80px">似乎出现了一点问题,请稍后再试!</h1><p style="text-align:center;margin-top:10px">There seems to be a problem, please try again later!</p>',
	// 显示错误信息
	...
	'log' => [
		// 设置为 test 则关闭日志记录
		'type' => APP_LOG ? 'File' : 'test',
		// 日志保存目录
		'path' => LOG_PATH,
		// 日志记录级别
		'single' => TRUE,
		'level' => ['error', 'sql', 'alert', 'info'],
	],
	// +----------------------------------------------------------------------
	...
	'token' => [
		...
		'type' => 'Mysql',
		// 缓存前缀
		'key' => '8ZdKrDSeLH2ntMvkRC7AyTluxO0bPQNc',
		// 加密方式
		'hashalgo' => 'ripemd160',
		// 缓存有效期 0表示永久缓存
		'expire' => 0,
